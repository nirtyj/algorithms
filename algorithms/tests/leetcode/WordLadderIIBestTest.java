...
public class WordLadderIIBestTest {

	@Test
	public void test() {
		String[] dictArr = { "hot", "dog", "dot" };
		List<String> dict = TestUtils.arrayToList(dictArr);
		assertEquals(3, WordLadderIIBest.findLadders("hot", "dog", dict).get(0).size());
	}
	...
	public void test2() {
		...
		List<String> dict = TestUtils.arrayToList(dictArr);
		assertEquals(5, WordLadderIIBest.findLadders("qa", "sq", dict).get(0).size());
	}
	...
	public void test3() {
		...
		List<String> dict = TestUtils.arrayToList(dictArr);
		assertEquals(2, WordLadderIIBest.findLadders("hit", "cog", dict).size());
	}
}
