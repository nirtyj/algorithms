...
public class SalesForce {
		 ...
		 implementing rate limiting for a web server
		 ...
		 Reverse string (collections & 2 pointers)
		 counts in word cloud data
		 return coin denominations question
		 LRU cache
		 merge ranges
		 ...
		 Find connecting points of 2 linked list
